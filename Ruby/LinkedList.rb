...
node_5 = Node.new("LimeTree")
node_4.next_node = node_5

node_6 = Node.new("Ayoola")
...
class LinkedList
  ...
  def insert_at_index(index, value)
   ...
   def delete_at_index(index)
    ...
    # First, we find the index immediately before the one we
...
p list.read(3)
p list.index_of("Ayoola")
list.insert_at_index(3, "Bath Uni")
